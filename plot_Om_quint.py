...
if quint:
   dir = '/Users/visinelli/Documents/CAMB2016/camb_quint/inifiles/'
   root        = 'test_quint_'
   val = pd.read_csv(dir + root + 'values.dat', names =['B', 'lambda', 'H0', 'rs', 's8', 'Om'])
   colspecs=([0,15],[24,37],[45,59])
   
else:
   dir = '/astro/u/jvazquez/BOSS/cosmomc_july_14/camb/'
   root = 'test_ede_'
   val = pd.read_csv(dir + root + 'values.dat', names =['Ode', 'H0', 'rs', 's8', 'Om'])
   colspecs=([0,15],[24,37],[45,59])
