...
print *, 'omega2', Quint_GetOmegaFromInitial(astart,-1.0d0,initial_phidot,atol)
print *, 'omega3', Quint_GetOmegaFromInitial(astart,1.0d0,initial_phidot,atol)
print *, 'omega4', Quint_GetOmegaFromInitial(astart,-4.0d0,initial_phidot,atol)
    if (.false.) then
